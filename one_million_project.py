...
rendimento_atteso = st.slider("Qual è il rendimento atteso annuale previsto dai tuoi investimenti?", min_value=0.0, max_value=0.20, value=0.07, step=0.01)
inflazione = st.slider("Qual è l'inflazione attesa annuale?", min_value=0.0, max_value=0.20, value=0.02, step=0.01)
